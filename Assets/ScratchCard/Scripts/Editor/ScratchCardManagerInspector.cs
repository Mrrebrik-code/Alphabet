...
namespace ScratchCardAsset.Editor
{
	...
	public class ScratchCardManagerInspector : UnityEditor.Editor
	{
		...
		private SerializedProperty mousePosition;
		private int frameId;

		void OnEnable()
		{
			mousePosition = serializedObject.FindProperty("_mousePosition");
		...
		public override void OnInspectorGUI()
		{
			...
			EditorGUILayout.PropertyField(mousePosition, new GUIContent("Mouse"));
